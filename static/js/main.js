...
function setupStableButtonHandlers() {
    ...
    $(document).off('click', '.floor-option-btn').on('click', '.floor-option-btn', function (e) {
        ...
        $('.floor-option-btn').blur();

        // 強制 DOM 重繪
        $('.floor-option-btn').each((i, btn) => {
            void btn.offsetHeight;
        });
    ...
    $(document).off('click', '.location-option-btn').on('click', '.location-option-btn', function (e) {
        ...
        $('.location-option-btn').blur();

        // 強制 DOM 重繪
        $('.location-option-btn').each((i, btn) => {
            void btn.offsetHeight;
        });
...
function showFloorModal() {
    ...
    setTimeout(() => {
        ...
        // 再次確保狀態正確
        setTimeout(() => {
            $('.floor-option-btn').removeClass('active');
        }, 10);
    }, 10);
}
...
function showLocationModal() {
    ...
    setTimeout(() => {
        ...
        // 再次確保狀態正確
        setTimeout(() => {
            $('.location-option-btn').removeClass('active');
        }, 10);
    }, 10);
}
...
function closeModal($modal) {
    ...
    // 強制清除所有按鈕狀態
    $('.floor-option-btn, .location-option-btn').removeClass('active');
    $('.floor-option-btn, .location-option-btn').blur();

    // 強制 DOM 重繪
    $('.floor-option-btn, .location-option-btn').each((i, btn) => {
        void btn.offsetHeight;
    });
}
