...
function showReportForm() {
    ...
    // 🔥 英文精簡：修改為 Needs cleaning or repair
...
// 🔥 修正進度條：精簡英文避免換行，無照片時自動略過卡頓，流暢進入傳送階段
...
async function showFloorModal() {
    if (!isConfigLoaded) {
        ...
        await Promise.all([
            configFetchPromise,
            new Promise(resolve => setTimeout(resolve, 1200)) // 強制最少顯示 1.2 秒防閃現
        ]);
        hideLoadingOverlay();
    }
