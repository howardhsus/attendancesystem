...
// ==================== Modals & UI Controls (Anti-Ghost Click & Deduplicate) ====================
function showModalWithDelay(modalElement) {
    if(document.activeElement) document.activeElement.blur(); 
    document.body.style.overflow = 'hidden';
    modalElement.style.pointerEvents = 'none'; 
    modalElement.style.display = 'flex';
    setTimeout(() => modalElement.style.pointerEvents = 'auto', 350); 
}
...
function showLocationModal() {
    ...
    const locs = [...new Set(APP_CONFIG[currentService].locations_en)];
    const customHTML = `
